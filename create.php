...
$user = 'brs'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'Brs_989$'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'murbug887@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
